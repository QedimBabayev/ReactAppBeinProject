...
class CreateCustomerForm extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        console.log(this.props.state.barcode.card)
                            ...
                            <Row className='main_form_side'>
                                <Col xs={24} md={9} xl={24} className='left_form_wrapper' >
                                    ...
                                    <div className='form_item_with_icon_modal'>
                                        ...
                                        <UserAddOutlined onClick={this.props.openSecondModal} className='add_elements_modal' />
                                    </div>
...
const mapDispatchToProps = {
    getCard, putData, fetchData,putDataCustomer, getCustomerGroupsFastModal, putLocalStates,getCustomers
}
