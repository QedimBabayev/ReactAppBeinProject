    ...
    return (
        <div>
            ...
            >
                ...
                <CreateCustomerFormModal  openSecondModal={props.showChildrenDrawer} fetching={props.state.docmodals.fetching} datas={props.customerGr} />
                <Drawer
                    title="Müştəri qrupu"
                    width={400}
                    closable={false}
