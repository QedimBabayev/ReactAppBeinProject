...
class CreateProductGroupForm extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        ...
        if (nextProps.datas !== this.props.datas || nextProps.state.barcode.barcode !== this.props.state.barcode.barcode) {
            console.log(nextProps.state.barcode.barcode)
            this.formRef.current.setFieldsValue({
                barcode: nextProps.state.barcode.barcode
